...
class Recolha(Gclass):    
    ...
    # Class header title    
    header = 'Local de recolha'    
    # field description for use in, for example, in input form    
    des = ['Placa','Modelo','Ano','Valor Diário','Disponível']    
    # Constructor: Called when an object is instantiated    
    def __init__(self, placa, modelo, ano, localidade, disponivel):        
        super().__init__()        
        self._placa = placa        
        self._modelo = modelo        
        self._ano = int(ano)        
        ...
        Recolha.obj[placa] = self        
        Recolha.lst.append(placa)    
        # Object properties    
        ...
        # localidade property setter method    
        @localidade.setter    
